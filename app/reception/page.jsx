...
function Open() {
  ...
  return (
    <>
      ...
      <div className={`relative ${open && envelopeAnimDone ? "min-h-auto" : "full-h overflow-hidden"}`}>
        ...
        {open && envelopeAnimDone && (
          <>
            ...
            <div className="relative h-[100vh] w-full">
              <div className="sticky top-0 w-full overflow-hidden h-[100vh]"
                style={{ fontFamily: "'Georgia','Times New Roman',serif" }}>
